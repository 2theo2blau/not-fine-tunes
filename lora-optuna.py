...
def preprocess_function(examples: Dict[str, str], tokenizer, max_length: int = 512):
    ...
    # Don't pad during preprocessing - let the trainer handle it
    tokenized = tokenizer(
        texts,
...
def main():
    ...
    train_jsonl = "processed_data/harmful_responses_train.jsonl"
    eval_jsonl = "processed_data/harmful_responses_test.jsonl"  # optional

    # Specify model
    model_id = "mistralai/Mistral-Nemo-Instruct-2407"

    # Output directory
    output_dir = "./mistral-nemo-harm-finetuned-0215"
    ...
    def objective(trial: optuna.trial.Trial):
        ...
        lora_dropout = trial.suggest_float("lora_dropout", 0, 0.07, step=0.01)
    ...
    # Re-initialize base model for final training
    base_model = AutoModelForCausalLM.from_pretrained(
        model_id,
        trust_remote_code=True,
        device_map="auto",
